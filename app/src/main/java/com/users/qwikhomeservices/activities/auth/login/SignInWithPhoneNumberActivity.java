package com.users.qwikhomeservices.activities.auth.login;
    ...
    private void signInWithCredentials(PhoneAuthCredential phoneAuthCredential) {
        ...
        firebaseAuth.signInWithCredential(phoneAuthCredential).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                Intent intent = new Intent(SignInWithPhoneNumberActivity.this, com.users.qwikhomeservices.activities.home.MainActivity.class);
