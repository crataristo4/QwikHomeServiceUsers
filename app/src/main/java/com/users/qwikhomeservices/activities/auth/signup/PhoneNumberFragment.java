...
import com.users.qwikhomeservices.databinding.FragmentPhoneNumberBinding;
    ...
    private void signInWithCredentials(PhoneAuthCredential phoneAuthCredential) {
        ...
        firebaseAuth.signInWithCredential(phoneAuthCredential).addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                Intent intent = new Intent(getContext(), com.users.qwikhomeservices.activities.home.MainActivity.class);
